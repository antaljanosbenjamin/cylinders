...
class TableMaterial : public Material {
  ...
  public:
    TableMaterial(Number n_init, Number shine_init, Color F0_init, Color kd_init, Color ks_init,
                  MaterialType type_init, KAFunction getKAFunction, KDFunction getKDFunction);
